 ...
 */
public interface SceneLostGoodsService {
     ...
     * @param t
     */
    public JsonResult updateById(String token, SceneLostGoods t);

    /**
     * 新增
     * @param t 新增对象
     */
    public JsonResult add(String token, SceneLostGoods t);

    /**
     * 批量新增
     * @param list 对象列表
     */
    public JsonResult addBatch(String token, List<SceneLostGoods> list);

    /**
     * 分页查询
     * @param filter 查询条件对象
     */
    public JsonResult queryPage(SceneLostGoods filter);
    /**
     * 根据勘验ID查询损失物品
     * 方法功能说明：  
