 ...
 */
public interface SceneAnalysisSuggestionService {
     ...
     * @param t
     */
    public JsonResult updateById(String token, SceneAnalysisSuggestion t);

    /**
     * 新增
     * @param t 新增对象
     */
    public JsonResult add(String token, SceneAnalysisSuggestion t);

    /**
     * 批量新增
     * @param list 对象列表
     */
    public JsonResult addBatch(String token, List<SceneAnalysisSuggestion> list);

    /**
     * 分页查询
     * @param filter 查询条件对象
     */
    public JsonResult queryPage(SceneAnalysisSuggestion filter);
    /**
     * @param investigationId 
     * 根据勘验ID查询分析意见
     * 方法功能说明：  
     * 创建：2016-12-12 下午3:47:49 by guochen
     * @参数： 
     * @参数：    
     * @return  
     * @throws
