...
import com.hisign.xcky.constant.DateStyle;
import com.hisign.xcky.constant.Week;
...
//        System.out.println(df);
     ...
     * @see SimpleDateFormat
     */
    public static final String convertDateToString(String pattern, Date aDate) throws Exception {
	...
	*/
	 ...
	 * 增加日期的秒钟。失败返回null。
	 * @param date 日期字符串
	 * @param secondAmount 增加数量(int)。可为负数
	 * @return 增加秒钟后的日期字符串
	 */
