...
(function() {
	...
	var cc = {
		imgPath : top.hsmapPath||(top.path+'/dist/plugin/hsmap/')+"images/",                                                          //******* �Ķ�ͼƬimages·�� *******
		cityNames : {
			"\u5317\u4eac" : "bj",
			"\u4e0a\u6d77" : "sh",
			"\u6df1\u5733" : "sz",
	...
	a8.object.extend(cA, {
		...
		preLoaded : {},
		Config : {
			_baseUrl : top.path+'/dist/plugin/hsmap/js',//"js/", //x + "getmodules?v=1.3",                          //******* �Ķ���Դ��map,oppc,tile,control��·�� *******
			_timeout : 5000
		},
		delayFlag : false,
		Module : {
