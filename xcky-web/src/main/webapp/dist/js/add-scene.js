importing('dict','popover', 'slick','datepicker','mappicker','hsmap',function () {
    ...
    addScene.regEvent = function () {
        ...
        $('body').on('change', '#xct-add #xct-add-pic', function () {
            ...
            var $this = $(this);
            addScene.uploadImg(file, function (res) {
        ...
        $('.main-content').on('click', '#add-scene-xczp .add-pic', function () {
            var $this = $(this);
            var picLength = $(this).closest('.form-field .ul-img').children('div').length;
        ...
        $('body').on('click', '#xctp-add .save-add', function () {
            $('#xctp-add .save').trigger('notClose');
            $('#xctp-add').find('input:text, textarea').val('');
            $('#xctp-add').find('input[type="hidden"]').val('');
        });
        //现场图片的 取消
    ...
    //图片上传方法
    window.uploadFile = addScene.uploadImg = function (domEle, cb) {
        // 图片检测
    ...
    addScene.dictInit = function () {
        ...
        //案情信息 报案人||被害人
        var act = makeAct('sys/sysDict/single/SARYLBDM');
        $get(act, null, function (res) {
        ...
        $post(act, param, function (res) {  //指挥人员字典
            ...
            $post(act, {}, function (res1) {
                $('#zhry-dict').data('info', res1.data);
                $('#zhry-dict').dict(res1.data, d);
            }, false);
        }, false);
        act = makeAct('sceneCollecting/investigatorHistory/queryAll', '');
        param = {duty: "0"};
        $post(act, param, function (res) { //勘验人员字典
            _kyry = res.data;
            var d = res.data.select('o => {dictValue: o.investigatorName, dictKey: o.investigatorId}');
        ...
        //分析意见  ----------------------------------------------------
        act = makeAct('/sys/sysDict/single/FXYJXMDM');
        $get(act, null, function (res) {
            $('#add-scene-fxyj').find('.type-in-label-m').each(function () {
                localData.set('fxyj-dictkey', res.data);
                var $this = $(this);
        ...
        //工具类别
        act = makeAct('/sys/sysDict/single/ZAGJLMDM');
        $get(act, null, function (res) {
            localData.set('fxyj-gjlb', res.data);
        }, false);
        //工具来源
        ...
        // 尸体信息 ----------------------------------------------------
        act = makeAct('/sceneCollecting/dictComm/queryAll');
        var liArr;
        //体表特殊标记
        $post(act, {dictType: 'TBTSBJDM'}, function (res) {
            liArr = [];
    ...
    $('.main-content').on('click', '#add-scene-hjwz .hjwz-tabs>li', function(){
        ...
        $input.on('change', function() {
            addScene.uploadImg($input.get(0).files[0], function(res){
                var tb = $('#dzwz-camera-table');
    ...
    $('#hjwz-print-block').on('click', '#print-cancel', function(){
        ...
        addScene.uploadImg(byid('print-pic-file').files[0], function(res){
    ...
    $('#hjwz-foot-block').on('click', '#foot-cancel', function(){
        ...
        addScene.uploadImg(byid('foot-pic-file').files[0], function(res){
    ...
    $('#hjwz-bio-block').on('click', '#bio-cancel', function(){
        ...
        addScene.uploadImg(byid('bio-pic-file').files[0], function(res){
    ...
    $('#hjwz-tool-block').on('click', '#tool-cancel', function(){
        ...
        addScene.uploadImg(byid('tool-pic-file').files[0], function(res){
    ...
    $('#hjwz-gun-block').on('click', '#gun-cancel', function(){
        ...
        addScene.uploadImg(byid('gun-pic-file').files[0], function(res){
    ...
    $('#hjwz-special-block').on('click', '#special-cancel', function(){
        ...
        addScene.uploadImg(byid('special-pic-file').files[0], function(res){
    ...
    $('#hjwz-drug-block').on('click', '#drug-cancel', function(){
        ...
        addScene.uploadImg(byid('drug-pic-file').files[0], function(res){
    ...
    $('#hjwz-physic-block').on('click', '#physic-cancel', function(){
        ...
        addScene.uploadImg(byid('physic-pic-file').files[0], function(res){
    ...
    $('#hjwz-doc-block').on('click', '#doc-cancel', function(){
        ...
        addScene.uploadImg(byid('doc-pic-file').files[0], function(res){
    ...
    $('#hjwz-elec-block').on('click', '#elec-cancel', function(){
        ...
        addScene.uploadImg(byid('elec-pic-file').files[0], function(res){
    ...
    $('#hjwz-video-block').on('click', '#video-cancel', function(){
        ...
        addScene.uploadImg(byid('video-pic-file').files[0], function(res){
    ...
    $('#hjwz-others-block').on('click', '#others-cancel', function(){
        ...
        addScene.uploadImg(byid('others-pic-file').files[0], function(res){
    ...
    $('#hjwz-camera-block').on('click', 'u', function(){
        ...
        if(index > -1){
            ...
            var tid = cameraInfo.where('o => o.uuid == "{0}"'.format(uuid)).id;
            if(tid){
    ...
    $('#hjwz-add-camera').on('click', '#add-camera-save', function(){
        ...
        addScene.uploadImg(byid('camera-pic-file').files[0], function(res){
...
*/
    ...
    $('.main-content').on('click','#aqxx-ajlb',function () {//点击案件类别编辑  ,.main-content
        ...
        $confirm('修改案件性质会清空案件性质相关的模板生成信息。<br><br>确定要修改么？',function (bol) {
            if(bol){
                $('#edit-case-nature-block').$open({width:800,title:'案件性质'});
            }
        });
    ...
    $body.on('ex-change',function (e,selector,val) {
...
//            });
    ...
    $('#edit-case-type-block').on('click','#ectb-confirm-btn',function () {
        ...
        addScene.setCache(setCache);
//            $body.trigger('ex-change',[$('#aqxx-ajlb,#aqxx-ajxz').prev('em')]);
