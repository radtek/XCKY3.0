...
},{"../data/config.json":1,"./business/pub-business":2,"./filter.js":4,"./lib/defineding.js":5,"./lib/eui":6,"./lib/exy":7,"./lib/index.state.js":8,"./lib/jquery":11,"./lib/jquery.cookie":9,"./lib/locals":13,"./lib/mock-register.js":14,"./lib/paging.js":15,"./lib/patch.js":16,"./lib/path.js":17,"./lib/proto":19,"./lib/pub":20,"./lib/stp":24,"./lib/validate.js":27,"./state.js":29,"./widget.js":30}],4:[function(require,module,exports){
/**
...
},{"./stp.widget":26}],8:[function(require,module,exports){
/**
...
return jQuery;
    ...
    module.exports={
        ...
        each:function(foo){return this.forEach($lambda(foo))},
        remove:function(i){return this.splice(i,1);},
        has:function(item,bol){return this.indexOf(item,bol)+1;},
        any:function (foo) {
            var the=this;
            return the.some($lambda(foo));
        },
        where:function(foo){
                    var the=this;
                    return the.filter( $lambda(foo));
                },
        select:function(foo){
                    var the=this;
                    return the.map($lambda(foo));
                },
        update:function (foo) {
		 ...
		 $.fn.pagingList=function(config) {
			...
			//该函数就是一个restful封装
			 ...
			 var pageHandle=function(_begin,_end,newSearch,pageIndex,pageOnce,totalCount){
				 ...
				 //先检测缓存有效期
				 ( localCache[id].time+3*60*1000 > new Date().getTime() ) || resetCache(id);
				 //有缓存就使用, 没缓存去请求
...
},{"./lambda":12}],20:[function(require,module,exports){
...
},{"./jquery.extend":10,"./previewbox":18,"./win":28}],21:[function(require,module,exports){
/**
...
},{"./stp.customcols":21,"./stp.filter":22,"./stp.fixtable":23,"./stp.table":25}],25:[function(require,module,exports){
/**
 * Created by yao on 2016/11/15.
 */
